...
de_odp <- odp(de_obj, bs.its = 100, verbose=FALSE)
...
de_odp <- odp(de_sva, bs.its = 100, verbose = FALSE)
...
<<snm_odp2>>=
de_odp <- odp(de_snm, bs.its = 100, verbose=FALSE)
summary(de_odp)
@
...
de_obj <- odp(de_obj, bs.its = 100, verbose = FALSE)
@
